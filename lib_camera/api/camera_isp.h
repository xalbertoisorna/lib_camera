...
#define MODE_RAW_MAX_SIZE           (SENSOR_WIDHT)
#define MODE_RGB1_MAX_SIZE          (SENSOR_WIDHT >> 2)
#define MODE_RGB2_MAX_SIZE          (SENSOR_WIDHT >> 1)
#define MODE_RGB4_MAX_SIZE          (SENSOR_WIDHT)
